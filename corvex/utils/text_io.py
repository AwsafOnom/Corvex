...
Corvex run on a cp1252 machine is not valid UTF-8, so a strict UTF-8 read
...
def read_text_utf8(path: Any) -> str:
    ...
    Falls back to the locale encoding for files an older Corvex wrote under
    ...
    try:
        ...
        logging.warning(
            ...
            f"It was likely written by an older Corvex run on a non-UTF-8 "
