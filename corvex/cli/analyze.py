#!/usr/bin/env python3
"""
corvex analyze - Interactive Analysis Orchestrator
...
def main():
    """Main entry point for 'corvex analyze' command"""
    
    parser = argparse.ArgumentParser(
        prog='corvex analyze',
        description='Corvex Analysis Orchestrator - Interactive AI Analysis Agent',
...
Examples:
  ...
  corvex analyze --mode autopilot --data ./data/
  
  # Full autonomous mode (runs entire pipeline automatically)
  corvex analyze --mode autonomous --data ./sample.npy --metadata ./description.txt
  
  # Use a different model
  corvex analyze --model gemini-2.0-flash
  
  # Use Claude
  corvex analyze --model claude-sonnet-4-20250514
  
  # Use OpenAI
  corvex analyze --model gpt-4o

Analysis Modes (matching 'corvex plan' for consistent UX):
  ...
  (or provide metadata interactively during session)
    ...
    parser.add_argument(
        ...
        help=(
            ...
            'Example: corvex analyze --agents ./my_xrd_agent.py'
        )
    )
    ...
    parser.add_argument(
        ...
        help=(
            ...
            'Example: corvex analyze --skills ./raman_skill.md ./ftir_skill.md'
        )
    )
    ...
    parser.add_argument(
        ...
        help=(
            ...
            'Example: corvex analyze --tools ./image_analysis_tools.py'
        )
    )
    ...
    parser.add_argument(
        ...
        help=(
            ...
            'Example: corvex analyze --mcp stdio:fs:npx,-y,@modelcontextprotocol/server-filesystem,/tmp'
        )
    )
    ...
    if args.mp_api_key:
        import corvex
        corvex.set_api_key('materials_project', args.mp_api_key)
...
class AnalysisPlayground:
    ...
    def setup(self):
        ...
        print("\n" + "="*60)
        print("🔬 CORVEX ANALYSIS ORCHESTRATOR")
        print("="*60)
        print("""
...
""")
    ...
    def handle_command(self, user_input: str) -> bool:
        ...
        if cmd == "/help":
            ...
            from corvex.agents.exp_agents.analysis_orchestrator import AnalysisMode
            ...
            from corvex.agents.exp_agents.metadata_converter import METADATA_SCHEMA_DICT
            import json
            print("\n📋 Metadata Schema:")
