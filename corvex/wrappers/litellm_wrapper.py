...
All Corvex agents interact with LLMs through a single contract:
...
class LiteLLMGenerativeModel:
    ...
    This is the primary model wrapper used throughout Corvex. Every agent
    ...
    def generate_content(
        ...
        This is the single method all Corvex controllers call. It accepts
