...
``corvex.skills._shared._quality_metrics`` and also used by the NMR skill). It
...
TOOL_SPEC = ToolSpec(
    ...
    import_line="from corvex.skills.curve_fitting.xrd_profile.quality import peak_region_r2",
    signature=(
