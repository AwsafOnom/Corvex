...
TOOL_SPEC_SIMULATE = ToolSpec(
    ...
    import_line="from corvex.skills.curve_fitting.epr.axial_powder import simulate_axial_powder",
    signature=(
...
TOOL_SPEC_FIT = ToolSpec(
    ...
    import_line="from corvex.skills.curve_fitting.epr.axial_powder import fit_axial_powder",
    signature=(
