...
```python
from corvex.skills.curve_fitting.nmr.multipeak import fit_multipeak_voigt
...
```python
from corvex.skills.curve_fitting.nmr.multiplet import fit_jcoupled_multiplet
...
```python
from corvex.skills.curve_fitting.nmr.quadrupolar import fit_quad_czjzek
...
```python
from corvex.skills.curve_fitting.nmr.quadrupolar import fit_quad_ct
...
```python
from corvex.skills.curve_fitting.nmr.detection import assess_detection
...
```python
from corvex.skills.curve_fitting.nmr.quality import peak_region_r2
