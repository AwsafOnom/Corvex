...
TOOL_SPEC_SIMULATE = ToolSpec(
    ...
    import_line="from corvex.skills.curve_fitting.nmr.quadrupolar import simulate_quad_ct",
    signature=(
...
TOOL_SPEC_FIT = ToolSpec(
    ...
    import_line="from corvex.skills.curve_fitting.nmr.quadrupolar import fit_quad_ct",
    signature=(
...
TOOL_SPEC_CZJZEK = ToolSpec(
    ...
    import_line="from corvex.skills.curve_fitting.nmr.quadrupolar import fit_quad_czjzek",
    signature=(
