...
The metric is implemented once in ``corvex.skills._shared._quality_metrics``
...
TOOL_SPEC = ToolSpec(
    ...
    import_line="from corvex.skills.curve_fitting.nmr.quality import peak_region_r2",
    signature=(
