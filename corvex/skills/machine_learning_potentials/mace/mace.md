...
Scope through Corvex's MD pipeline. The atoms.info charge/spin/field
...
default spin, no field — i.e. as a standard MACE run. Until Corvex#463
...
for charged/field systems is pending Corvex#463)" 
