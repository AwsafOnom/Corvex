...
- ``"mip"`` — mixed-integer linear programming via PuLP. Jointly fits
  ...
  ``pulp`` (declared in ``corvex[structure-matching]``).
"""
...
TOOL_SPEC = ToolSpec(
    ...
    import_line="from corvex.skills.structure_matching.xrd.score_match_robust import score_xrd_match_robust",
    signature=(
...
TOOL_SPEC_MULTIPHASE = ToolSpec(
    ...
    import_line="from corvex.skills.structure_matching.xrd.score_match_robust import score_xrd_match_multiphase",
    signature=(
