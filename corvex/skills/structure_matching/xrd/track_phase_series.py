...
TOOL_SPEC = ToolSpec(
    ...
    import_line=("from corvex.skills.structure_matching.xrd.track_phase_series "
    ...
    parameters={
        ...
        "library_path": {"type": "str", "description": "Fingerprint parquet for source_id endmembers (default resolution: $CORVEX_XRD_FINGERPRINT_DB, then the per-user store)."},
