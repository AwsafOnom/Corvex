...
TOOL_SPEC = ToolSpec(
    ...
    import_line="from corvex.skills.structure_matching.xrd.simulate_xrd import simulate_xrd_pattern",
    signature=(
...
def simulate_xrd_pattern(
    ...
    try:
        ...
        raise ValueError(
            ...
            f"corvex.skills.structure_matching.xrd.simulate_xrd._ENGINES."
        )
