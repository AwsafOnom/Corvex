...
TOOL_SPEC = ToolSpec(
    ...
    import_line=("from corvex.skills.structure_matching.xrd.identify_mixture "
    ...
    parameters={
        ...
        "library_path": {"type": "str", "description": "Fingerprint parquet (default resolution: $CORVEX_XRD_FINGERPRINT_DB, then the per-user store)."},
