...
# ── Tool registry specs: auto-discovered by corvex.skills._shared._registry
...
TOOL_SPECS = [
    ToolSpec(
        ...
        import_line="from corvex.skills.image_analysis.crystalline_deformation.ptm_tools import ptm_classify",
    ...
    ToolSpec(
        ...
        import_line="from corvex.skills.image_analysis.crystalline_deformation.ptm_tools import ptm_classify_sweep",
    ...
    ToolSpec(
        ...
        import_line="from corvex.skills.image_analysis.crystalline_deformation.ptm_tools import compute_cos",
