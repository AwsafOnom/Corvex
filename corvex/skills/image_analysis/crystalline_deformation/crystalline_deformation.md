...
detection:
```python
from corvex.skills.image_analysis.atomic_stem.atom_finding import detect_atoms
...
```python
from corvex.skills.image_analysis.crystalline_deformation.ptm_tools import ptm_classify, ptm_classify_sweep, compute_cos
...
```python
from corvex.skills._shared.strain import gpa_strain_map
from corvex.skills.image_analysis.crystalline_deformation.gpa_tools import burgers_from_gpa
