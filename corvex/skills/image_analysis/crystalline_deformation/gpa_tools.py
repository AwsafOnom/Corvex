...
``corvex.skills._shared.strain.gpa_strain_map`` (exx, eyy, exy, wxy) —
...
def burgers_from_gpa(e_xx, e_yy, e_xy, w_z, pixel_size,
    ...
    e_xy : 2-D ndarray
        ...
        ``corvex.skills._shared.strain.gpa_strain_map``.
    w_z : 2-D ndarray
...
TOOL_SPECS = [
    ToolSpec(
        ...
        import_line="from corvex.skills.image_analysis.crystalline_deformation.gpa_tools import burgers_from_gpa",
        signature=(
