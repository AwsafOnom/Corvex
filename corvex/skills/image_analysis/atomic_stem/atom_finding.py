...
def detect_atoms_dcnn(
    ...
    try:
        ...
        from corvex.skills._shared.atomistic_model_manager import get_or_download_atomistic_model
...
from corvex.skills._shared._spec import ToolSpec
...
TOOL_SPECS = [
    ToolSpec(
        ...
        import_line="from corvex.skills.image_analysis.atomic_stem.atom_finding import detect_atoms",
        signature=(
    ...
    ToolSpec(
        ...
        import_line="from corvex.skills.image_analysis.atomic_stem.atom_finding import detect_atoms_dcnn",
        signature=(
    ...
    ToolSpec(
        ...
        import_line="from corvex.skills.image_analysis.atomic_stem.atom_finding import refine_positions",
    ...
    ToolSpec(
        ...
        import_line="from corvex.skills.image_analysis.atomic_stem.atom_finding import find_zone_axes",
    ...
    ToolSpec(
        ...
        import_line="from corvex.skills.image_analysis.atomic_stem.atom_finding import find_missing_atoms",
    ...
    ToolSpec(
        ...
        import_line="from corvex.skills.image_analysis.atomic_stem.atom_finding import subtract_atoms",
        signature=(
    ...
    ToolSpec(
        ...
        import_line="from corvex.skills.image_analysis.atomic_stem.atom_finding import local_env_gmm",
        signature=(
    ...
    ToolSpec(
        ...
        import_line="from corvex.skills.image_analysis.atomic_stem.atom_finding import type_sublattice_defects",
        signature=(
    ...
    ToolSpec(
        ...
        import_line="from corvex.skills.image_analysis.atomic_stem.atom_finding import map_polarization",
        signature=(
