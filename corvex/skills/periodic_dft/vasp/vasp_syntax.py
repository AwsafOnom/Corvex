...
and called through
:func:`corvex.skills._shared._registry.get_tool_function`.
"""
...
TOOL_SPEC_INPUT_SYNTAX = ToolSpec(
    ...
    import_line="from corvex.skills.periodic_dft.vasp.vasp_syntax import check_input_syntax",
    agents=["simulation"],
...
TOOL_SPEC_CHECK = ToolSpec(
    ...
    import_line="from corvex.skills.periodic_dft.vasp.vasp_syntax import check_incar_syntax",
    agents=["simulation"],
    returns=(
...
TOOL_SPEC_FIX = ToolSpec(
    ...
    import_line="from corvex.skills.periodic_dft.vasp.vasp_syntax import apply_incar_syntax_fixes",
    agents=["simulation"],
...
TOOL_SPEC_INPUT_FIX = ToolSpec(
    ...
    import_line="from corvex.skills.periodic_dft.vasp.vasp_syntax import apply_input_syntax_fixes",
    agents=["simulation"],
