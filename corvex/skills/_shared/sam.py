...
corvex's ParticleAnalyzer (supports both grayscale and RGB input) while adding:
...
def get_or_create_sam_model(params: dict) -> Any:
    ...
    """
    from corvex.skills._shared.particle_analyzer import ParticleAnalyzer
    ...
    if checkpoint:
        ...
        default_dir = Path.home() / ".cache" / "corvex" / "checkpoints"
...
TOOL_SPEC = ToolSpec(
    ...
    import_line="from corvex.skills._shared.sam import run_sam_analysis",
