...
Tool modules in ``corvex/skills/_shared/`` declare their spec at module level:
...
The walker in ``corvex.skills._shared._registry`` discovers these and filters by the
``agents`` tag.
"""
