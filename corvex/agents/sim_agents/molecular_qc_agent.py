# corvex/agents/sim_agents/molecular_qc_agent.py
"""
...
bundles at corvex/skills/molecular_qc/<engine>/<engine>.md and the
...
class MolecularQCAgent:
    ...
    skill bundles at ``corvex/skills/molecular_qc/<engine>/<engine>.md``.
    ...
    def supported_software(cls) -> list:
        ...
        provided roots from ``$CORVEX_SKILLS_PATH``. A user dropping
    ...
    def _load_skill(self, skill: str) -> dict:
        ...
        ----------
        skill : str
            Skill name (resolved from ``corvex/skills/molecular_qc/``)
    ...
    def generate_inputs(self, structure_file: str,
        ...
        bundle at ``corvex/skills/molecular_qc/<software>/``); the skill
