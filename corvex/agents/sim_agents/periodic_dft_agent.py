# corvex/agents/sim_agents/periodic_dft_agent.py
"""
...
skill bundles at corvex/skills/periodic_dft/<engine>/<engine>.md and
...
class PeriodicDFTAgent:
    ...
    ``corvex/skills/periodic_dft/<engine>/<engine>.md``.
    ...
    def _load_skill(self, skill: str) -> dict:
        ...
        ----------
        skill : str
            Skill name (resolved from ``corvex/skills/periodic_dft/``)
    ...
    def generate_inputs(self, structure_file: str,
        ...
        bundle at ``corvex/skills/periodic_dft/<software>/``); the
