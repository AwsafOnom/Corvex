...
So adding an MD engine is "Interchange supports it", not new Corvex code: this
helper dispatches generically by engine name (Corvex's ``software`` keywords —
...
inside the functions and gated behind the ``corvex[ff]`` extra, so importing
