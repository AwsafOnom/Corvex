...
class SimulationOrchestratorTools:
        ...
        def run_exafs_workflow(
            ...
            return json.dumps({
                ...
                "next_steps": (
                    ...
                    f"   from corvex.skills.exafs_simulation.exafs_workflow.feff_tools "
    ...
    def _load_skill_content(self, skill) -> Optional[str]:
        ...
        Resolution order per skill:
          1. Built-in skills under corvex/skills/structure_generation/<name>/
    ...
    def _render_one_skill(self, skill_name: str) -> Optional[str]:
        ...
        try:
            ...
            if not path:
                ...
                return None
            try:
                from corvex.skills.loader import load_skill as _load
                parsed = _load(path)
            except Exception as e:
