...
class MetaOrchestratorTools:
    ...
    def _register_all_tools(self):
        ...
        def delegate_to_simulation(task: str, context: dict = None,
                                   context_from: list = None,
                                   label: str = None) -> str:
            # Guarded import INSIDE the function: corvex.agents.sim_agents
        ...
        def view_image(paths, question: str = None) -> str:
            ...
            from corvex.parsers.ocr import describe_image
        ...
        def view_document(paths, figures: str = "auto") -> str:
            ...
            from corvex.parsers import extract_document, extract_text
            from corvex.parsers.docx_document import count_docx_figures
