...
def _append_tool_inventory(
    ...
    Tools come from ``corvex.skills._shared._registry.get_tools_for(agent, active_skills)``;
...
class UnifiedImageProcessingController:
    ...
    _TOOL_CONSTRAINT_SCHEDULE = (
        ...
        "`corvex.skills.*`), your suggested fixes must be achievable via that "
...
<body>
    <div class="container">
        ...
        {claims_html}
        {caveats_html}
        <div class="footer">Generated by Corvex Image Analysis Agent</div>
    </div>
</body>
</html>"""
