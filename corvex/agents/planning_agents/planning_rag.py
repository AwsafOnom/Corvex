...
from corvex.parsers import parse_adaptive_excel
from corvex.knowledge import run_rag, parse_json_from_response
...
def perform_science_rag(objective: str,
    ...
    Thin planning-side wrapper over the shared ``corvex.knowledge.run_rag``
