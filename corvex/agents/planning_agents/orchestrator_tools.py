...
_LIT_AUTOLOAD_MAX_CHARS = int(os.environ.get(
    "CORVEX_LIT_AUTOLOAD_MAX_CHARS", 400_000))
...
# the prose INSIDE a section; these boundaries are Corvex-authored, so
...
class OrchestratorTools:
    ...
    def _split_literature_sections(text: str) -> list:
        ...
        Boundaries are the Corvex-authored '# Question N: <objective>'
    ...
    def _output_dir(self):
        ...
        artifacts; for direct `corvex plan` use it is the campaign root
    ...
    def _register_all_tools(self):
        ...
        def _query_directory(dir_entry: dict, query: str) -> str:
            ...
            for attempt in range(2):
                ...
                try:
                    from corvex.knowledge import parse_json_from_response
        ...
        def screen_database(query: str, database_path: str,
            ...
            import subprocess
            from corvex.executors import require_sandbox_approval
            ...
            for attempt in range(max_retries):
                ...
                try:
                    ...
                    mp_preamble = (
                        "import multiprocessing as _corvex_mp\n"
                        "try: _corvex_mp.set_start_method('fork', force=True)\n"
        ...
        def graduate_to_skill(knowledge_id: str, skill_name: str, domain: str = "planning") -> str:
            ...
            # Write to the persistent store (~/.corvex/graduated_skills) via
