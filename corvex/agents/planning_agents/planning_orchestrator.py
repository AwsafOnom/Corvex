...
class PlanningOrchestratorAgent:
    ...
    def __init__(
        ...
        # persistent store (corvex kb create/list) — an existing path wins
        ...
        # overwrite the previous one's artifacts. Direct `corvex plan` use
        ...
        if self.knowledge_dir:
            if self._kb_store_manifest is not None:
                ...
                # artifact — mutate the store only via 'corvex kb'). Seed a
