...
Every agent-level human-feedback prompt in Corvex routes through
...
confirmations in ``corvex memory`` / ``corvex kb``, and the sandbox
...
class FeedbackRequest:
    ...
    is the answer that means "accept as-is" — for almost every Corvex
