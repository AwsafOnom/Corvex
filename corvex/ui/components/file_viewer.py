...
# is #4F6BEB, an indigo that is barely legible against the dark pane.
...
/* The UNSELECTED segment keeps the dark backgroundColor from config.toml
   even in light mode, where the label flips dark — #212121 on #13161B, a
...
def render_file_preview(file_path: Path) -> None:
    ...
    if pdf_col is not None:
        with pdf_col:
            try:
                from corvex.ui.md_images import pdf_twin
                ...
                if twin is not None:
                    ...
                    from corvex.utils.md_to_pdf import markdown_to_pdf
                    import tempfile
    ...
    if suffix == ".md":
        ...
        if view == "Source":
            ...
            from corvex.ui.md_images import inline_local_images
