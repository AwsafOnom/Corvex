...
Opus 4.8, against an ISOLATED bank (CORVEX_HOME -> temp dir).
...
if __name__ == "__main__":
    assert os.environ.get("CORVEX_HOME"), \
        "Set CORVEX_HOME to an isolated temp dir before running."
    os.environ.setdefault("CORVEX_SCRIPT_BANK", "1")
