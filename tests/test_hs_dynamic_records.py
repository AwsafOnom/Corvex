...
from corvex.agents.exp_agents.controllers.hyperspectral_controllers import (  # noqa: E402
...
from corvex.agents.exp_agents.instruct import (  # noqa: E402
...
def test_staging_gate_on_records(monkeypatch, tmp_path):
    ...
    from corvex.agents.exp_agents import hyperspectral_analysis_agent as hsa

    staged_calls = []

    import corvex.skills._shared._staging as _staging_mod
    ...
    monkeypatch.setattr("corvex.skills.loader.memory_enabled", lambda: True)
    ...
    monkeypatch.delenv("CORVEX_T2_AUTODISTILL", raising=False)
