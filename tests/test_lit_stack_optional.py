...
import corvex.agents.exp_agents.analysis_orchestrator_tools  # noqa: F401
from corvex.agents.lit_agents import OwlLiteratureAgent, MoleculesAgent
...
def test_intact_stack_constructs_normally():
    ...
    from corvex.agents.lit_agents.literature_agent import (
