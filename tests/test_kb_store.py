"""Offline tests for the named knowledge-base store (corvex.knowledge.kb_store).
...
def store(tmp_path, monkeypatch):
    """Isolated store under a temp CORVEX_HOME."""
    monkeypatch.setenv("CORVEX_HOME", str(tmp_path / "home"))
...
class TestKnowledgePathFallback:
    ...
    def test_created_kb_records_final_sources_path(self, store, tmp_path,
        ...
        import corvex.knowledge.knowledge_base as kbmod
        monkeypatch.setattr(kbmod, "KnowledgeBase", FakeKB)
        import corvex.parsers as parsers
