...
from corvex.session_events import HISTORY_TOOL_NAMES, use_event_log


def _seed_log(base_dir, n=20):
    log = base_dir / "events.jsonl"
    with use_event_log(log):
        from corvex.session_events import append_event
...
def test_search_never_matches_its_own_past_calls(orchestrators):
    ...
    from corvex.session_events import use_event_log as uel
...
def test_fanout_branch_events_land_in_meta_log(tmp_path, monkeypatch):
    ...
    import corvex.agents.meta_agent.fanout as fo
