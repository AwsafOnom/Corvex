...
from corvex.parsers.docx_document import (
    count_docx_figures, load_docx, rows_to_markdown)
from corvex.parsers.extract import extract_document, extract_text
...
def test_bmp_and_tiff_are_converted_rather_than_shipped(tmp_path):
    ...
    from docx.shared import Inches
    from PIL import Image
    from corvex.parsers.docx_document import SUPPORTED_IMAGE_MIMES
...
def test_an_unconvertible_figure_keeps_its_number(tmp_path):
    ...
    from corvex.parsers.docx_document import Figure, _normalize_figure
