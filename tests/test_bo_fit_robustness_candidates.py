...
from corvex.agents.planning_agents.bo_tools import (
...
def _make_agent(tmp, stub):
    from corvex.agents.planning_agents import OptimizationAgent
...
def test_fit_failure_reenters_strategy_with_context(tmp_path, monkeypatch):
    torch.manual_seed(0)
    from corvex.agents.planning_agents import bo_agent as bo_agent_mod
