...
Three layers, each degrade-never-hang:
  ...
  conda run -n corvex python tests/test_wallclock_budget.py
"""
import json
import logging
import os
...
from corvex.agents.meta_agent.meta_orchestrator import MetaOrchestratorAgent, MetaMode
...
import corvex.agents.exp_agents.analysis_orchestrator  # noqa: F401
...
def test_engine_budget():
    from corvex.agents.exp_agents._qc_engine import (
...
def test_preprocess_budget():
    from corvex.agents.exp_agents.preprocess import HyperspectralPreprocessingAgent
