...
importing ``corvex.agents.sim_agents`` first.
"""
...
def test_meta_imports_without_ase():
    ...
    r = _run(
        ...
        import corvex.agents.meta_agent.meta_orchestrator  # noqa: F401
        assert 'corvex.agents.sim_agents.simulation_orchestrator' not in sys.modules
        print('OK')
        """
    )
    assert "OK" in r.stdout, r.stderr
