...
from corvex.skills.structure_matching.xrd import _gsas_engine as ge
from corvex.skills.structure_matching.xrd import simulate_xrd as sx
...
def test_refine_rietveld_registered_and_knobs():
    from corvex.skills.structure_matching.xrd.refine_rietveld import TOOL_SPEC
...
def test_index_pattern_registered_and_knobs():
    from corvex.skills.structure_matching.xrd.index_pattern import TOOL_SPEC
    from corvex.skills._shared._registry import get_tools_for
    names = {t.name for t in get_tools_for("structure_matching", active_skills=["xrd"])}
...
def test_validate_cell_lebail_registered_and_knobs():
    from corvex.skills.structure_matching.xrd.validate_cell import TOOL_SPEC
    from corvex.skills._shared._registry import get_tools_for
    names = {t.name for t in get_tools_for("structure_matching", active_skills=["xrd"])}
