...
from corvex.skills.loader import list_all_skills, load_skill
...
def model():
    from corvex.wrappers.litellm_wrapper import LiteLLMGenerativeModel
...
def test_aimsgb_extras_section_reaches_consumer(model):
    ...
    from corvex.agents.sim_agents.simulation_orchestrator_tools import (
...
def test_registry_discovers_all_tool_specs_after_move():
    ...
    from corvex.skills._shared._registry import _all_specs
...
def test_force_field_agent_amber_alias_resolved_after_move():
    ...
    from corvex.agents.sim_agents import force_field_agent as ffa
...
def test_atomistic_agent_alias_resolved_after_move():
    ...
    from corvex.agents.exp_agents import atomistic_microscopy_agent as ama
...
def test_all_analysis_agents_import_cleanly():
    ...
    modules = [
        "corvex.agents.exp_agents.analysis_orchestrator",
        "corvex.agents.exp_agents.analysis_orchestrator_tools",
        "corvex.agents.exp_agents.atomistic_microscopy_agent",
        "corvex.agents.exp_agents.curve_fitting_agent",
        "corvex.agents.exp_agents.fft_microscopy_agent",
        "corvex.agents.exp_agents.hyperspectral_analysis_agent",
        "corvex.agents.exp_agents.image_analysis_agent",
        "corvex.agents.exp_agents.sam_microscopy_agent",
        "corvex.agents.exp_agents.controllers.curve_fitting_controllers",
        "corvex.agents.exp_agents.controllers.image_analysis_controllers",
        "corvex.agents.exp_agents.controllers.fft_microscopy_controllers",
        "corvex.agents.exp_agents.controllers.sam_microscopy_controllers",
        "corvex.agents.exp_agents.controllers.atomistic_microscopy_controllers",
        "corvex.agents.exp_agents.controllers.hyperspectral_controllers",
        "corvex.agents.sim_agents.force_field_agent",
        "corvex.agents.planning_agents.bo_agent",
        "corvex.cli.prepare_ff",
    ]
...
def test_live_llm_can_route_via_moved_tool_inventory(model):
    ...
    from corvex.skills._shared._registry import format_tool_inventory
    ...
    assert "corvex.skills._shared.sam" in inventory
    assert "corvex.skills.image_analysis.atomic_stem.atom_finding" in inventory
...
def test_registry_filter_no_skills_active():
    ...
    from corvex.skills._shared._registry import get_tools_for
...
def test_force_field_agent_loads_multiple_skills():
    ...
    from corvex.agents.sim_agents.force_field_agent import ForceFieldAgent
    from unittest.mock import MagicMock
...
def test_force_field_get_skill_context_concatenates_multiple_skills():
    ...
    from corvex.agents.sim_agents.force_field_agent import ForceFieldAgent
    from corvex.skills.loader import load_skill
    from unittest.mock import MagicMock
...
def test_analyze_accepts_str_or_list_via_helper():
    ...
    from corvex.agents.exp_agents.base_agent import BaseAnalysisAgent
    from unittest.mock import MagicMock
...
def test_live_llm_does_not_hallucinate_old_tool_paths(model):
    ...
    `corvex.tools.*` paths anywhere in the response — that would mean the
    ...
    legacy_paths = (
        "corvex.tools.sam",
        "corvex.tools.fft_nmf",
        "corvex.tools.atom_finding_tools",
        "corvex.tools.amber_tools",
    )
