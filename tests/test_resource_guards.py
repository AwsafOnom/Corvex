...
fit_per_pixel worker cap, fusion-audit figure integrity).
  ...
  conda run -n corvex python tests/test_resource_guards.py
"""
import os
import tempfile
import threading
...
def main():
    import corvex.agents.meta_agent.fanout as fanout
    ...
    from corvex.skills._shared import parallel_pixel_fit as ppf
