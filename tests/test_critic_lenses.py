...
from corvex.agents.planning_agents.user_interface import format_caveats
from corvex.utils import doc_hygiene as dh
...
def test_literature_agent_has_adversarial_leg():
    from corvex.agents.lit_agents.literature_agent import LiteratureSearchAgent as LiteratureAgent
    calls = []
