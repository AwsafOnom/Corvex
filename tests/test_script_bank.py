...
Covers:
  ...
  - the enable gate (follows the persistent-memory master switch;
    ``CORVEX_SCRIPT_BANK`` overrides in both directions);
...
from corvex.skills._shared import _script_bank as sb
...
class TestManagementSurface:
    ...
    def test_proven_n_env_override(self, monkeypatch):
        ...
        monkeypatch.setenv("CORVEX_BANK_PROVEN_N", "2")
...
class TestVariantGroups:
    ...
    def test_group_promotion_shared_label_and_consolidate_flow(self, monkeypatch):
        ...
        monkeypatch.setenv("CORVEX_CONSOLIDATE_N", "2")
