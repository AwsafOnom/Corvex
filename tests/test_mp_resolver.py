...
def _check_mp_api_installed():
    try:
        ...
        print("   (or `pip install 'corvex[sim]'` to get the full sim stack)")
        sys.exit(2)
...
def test_0_orchestrator_plumbing(model_name: str):
    ...
    """
    from corvex.agents.sim_agents.structure_pipeline import StructurePipeline
    ...
    o = StructurePipeline(
        ...
        output_dir="/tmp/corvex_plumbing_check",
    ...
    try:
        from corvex.auth import clear_api_key
        ...
        o2 = StructurePipeline(
            ...
            generator_model=model_name,
            validator_model=model_name,
            output_dir="/tmp/corvex_plumbing_check_2",
            max_refinement_cycles=0,
        )
...
def test_1_disabled_mp_short_circuit(model_name: str):
    ...
    path. Restored after.
    """
    from corvex.agents.sim_agents.structure_agent import StructureGenerator
...
def test_6_full_workflow(model_name: str):
    ...
    """
    from corvex.agents.sim_agents.simulation_pipeline import run_complete_workflow
