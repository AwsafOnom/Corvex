...
from corvex.skills.molecular_dynamics.gromacs import gromacs as g
...
def test_gromacs_is_a_discovered_md_skill():
    from corvex.skills.loader import list_skills
    assert "gromacs" in list_skills(domain="molecular_dynamics")


def test_gromacs_is_registered_in_the_tool_registry():
    from corvex.agents.sim_agents.md_simulation_agent import _TOOL_REGISTRY
...
def test_entry_filename_is_engine_parameterized():
    from corvex.agents.sim_agents.md_simulation_agent import MDSimulationAgent
