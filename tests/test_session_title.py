...
sys.path.insert(0, "/Users/maxim.ziatdinov/Code/Corvex")
from corvex.ui.session_meta import generate_session_title
...
import corvex.ui.session_meta as sm
import inspect
...
sb = open("/Users/maxim.ziatdinov/Code/Corvex/corvex/ui/components/sidebar.py").read()
import re
...
app = open("/Users/maxim.ziatdinov/Code/Corvex/corvex/ui/app.py").read()
