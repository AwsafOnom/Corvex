...
renderer is unavailable.
  ...
  conda run -n corvex python tests/test_diagram_agent.py
"""
import os
import tempfile
...
from corvex.utils.mermaid_render import mermaid_available, render_mermaid
from corvex.agents.planning_agents.diagram_agent import DiagramAgent
