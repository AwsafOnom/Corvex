...
from corvex.agents.sim_agents.contradictions import (  # noqa: E402
    Requirement, format_requirements_for_prompt,
)
import corvex.agents.sim_agents.simulation_pipeline as sp  # noqa: E402
from corvex.agents.sim_agents.md_simulation_agent import MDSimulationAgent  # noqa: E402
from corvex.agents.sim_agents.periodic_dft_agent import PeriodicDFTAgent  # noqa: E402
...
class TestGateChecksList:
    ...
    def test_assess_signature_has_param(self):
        from corvex.agents.sim_agents.critics import RunCritic
    ...
    def test_refinement_context_carries_observables(self):
        from corvex.agents.sim_agents.refinement import RefinementContext
...
class TestDeterministicCheckers:
    ...
    def test_signal_present_flags_absent(self):
        from corvex.agents.sim_agents.contradictions import check_requirements
...
class TestGateDeterministicLayer:
    ...
    def test_blocks_missing_signal(self):
        from corvex.agents.sim_agents.refinement import _deterministic_coverage
...
class TestObservableDeriver:
    ...
    def _deriver(self):
        from corvex.agents.sim_agents.observable_requirements import (
...
class TestPipelineDerivation:
    ...
    def test_derivation_populates_generate(self, tmp_path, monkeypatch):
        import corvex.agents.sim_agents.observable_requirements as obs_mod
