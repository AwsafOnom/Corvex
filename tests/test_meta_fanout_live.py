...
Run (real code execution needs a sandbox; UNSAFE_EXECUTION_OK=true bypasses):
  ...
  conda run -n corvex python tests/test_meta_fanout_live.py            # gates only
  UNSAFE_EXECUTION_OK=true conda run -n corvex python tests/test_meta_fanout_live.py --full
"""
import argparse
import json
import os
