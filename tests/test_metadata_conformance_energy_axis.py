...
so Tier-2 LLM extraction fires. These assertions are deterministic (no LLM).
  ...
  conda run -n corvex python -m pytest tests/test_metadata_conformance_energy_axis.py -q
"""
from corvex.agents.exp_agents.metadata_converter import check_schema_conformance
