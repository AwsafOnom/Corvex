...
from corvex.utils.text_io import read_text_utf8, write_text_utf8
...
def test_read_recovers_a_legacy_cp1252_file_on_a_cp1252_host(
    ...
    """Artifacts an older Corvex wrote on Windows must still load there.
...
LITERATURE_IO_MODULES = [
    "corvex/agents/planning_agents/orchestrator_tools.py",
    "corvex/agents/exp_agents/analysis_orchestrator_tools.py",
]
