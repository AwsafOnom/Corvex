...
def _mix(cifs, cA, cB, grid, fwhm=0.15, eta=0.5, noise=2.0, bg=40.0):
    from corvex.skills.structure_matching.xrd.quantify_nnls import _profile_column
...
def test_tool_spec_registered():
    from corvex.skills.structure_matching.xrd.quantify_nnls import TOOL_SPEC
