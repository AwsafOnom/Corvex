...
from corvex.skills.structure_matching._backends import _cif_index
from corvex.skills.structure_matching._backends.local_cif import LocalCIFBackend
from corvex.skills.structure_matching._backends import QuerySpec
...
def isolated_cache(tmp_path, monkeypatch):
    ...
    cache_dir = tmp_path / "corvex_cache"
    cache_dir.mkdir()
