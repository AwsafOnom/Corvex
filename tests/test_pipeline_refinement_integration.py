...
import corvex.agents.sim_agents.critics as critics_mod  # noqa: E402
from corvex.agents.sim_agents.refinement import LocalExecutor  # noqa: E402
...
class TestWorkflowComposition:
    ...
    def _setup_md_with_manifest(self, tmp_path, monkeypatch):
        ...
        import corvex.agents.sim_agents._engine_inputs as ei
        import corvex.agents.sim_agents.force_field_agent as ffa
    ...
    def test_auto_fix_reparameterizes_and_proceeds(self, tmp_path, monkeypatch):
        ...
        import corvex.agents.sim_agents.refinement as rf
...
class TestGeneratedRemoteScript:
    ...
    def _load_generator(self):
        ...
        from corvex.ui.components.sim_workflow import _generate_run_script
