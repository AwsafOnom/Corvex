...
from corvex.agents.exp_agents._critique import CritiquePayload  # noqa: E402
from corvex.agents.exp_agents.controllers.base_controllers import (  # noqa: E402
...
def test_surface_features_modalities():
    from corvex.agents.exp_agents.base_agent import BaseAnalysisAgent as B
...
def test_reflection_pair_reexports_and_defaults():
    from corvex.agents.exp_agents.controllers import base_controllers as bc
    from corvex.agents.exp_agents.controllers import hyperspectral_controllers as hc
    from corvex.agents.exp_agents.instruct import SPECTROSCOPY_REFLECTION_INSTRUCTIONS
...
def test_refine_interpretation_features_include_extracted():
    ...
    import inspect
    from corvex.agents.exp_agents import analysis_orchestrator_tools as aot
