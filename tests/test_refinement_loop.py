...
from corvex.agents.sim_agents.refinement import (  # noqa: E402
    AutonomousPolicy,
    AutopilotPolicy,
    CoPilotPolicy,
    CycleDecision,
...
class TestCollectPhases:
    ...
    def test_single_phase_from_entry_file(self):
        from corvex.agents.sim_agents.simulation_pipeline import _collect_phases
...
class TestCollectStages:
    ...
    def test_legacy_shape_wraps_as_one_sequential_stage(self):
        from corvex.agents.sim_agents.simulation_pipeline import _collect_stages
        gr = {"input_files": {"run.lammps": "x"}, "entry_file": "run.lammps"}
...
class TestSweepGeneration:
    ...
    def test_expand_parameter_sweep_substitutes_placeholder(self):
        from corvex.skills.molecular_dynamics.lammps.lammps import (
    ...
    def test_sweep_member_name_is_safe(self):
        from corvex.skills.molecular_dynamics.lammps.lammps import sweep_member_name
    ...
    def test_assemble_fanout_stage_makes_self_contained_members(self):
        from corvex.agents.sim_agents.md_simulation_agent import (
