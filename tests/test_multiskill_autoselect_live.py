...
def image_ctx(img, meta):
    from corvex.skills._shared.image_analysis_tools import image_to_thumbnail_bytes
...
def tier_selector(model_name):
    from corvex.skills._shared._skill_selector import select_relevant_skills, build_skill_catalog
