"""Offline tests for corvex.skills._shared.fft_defect (synthetic lattices)."""
import numpy as np
import pytest

from corvex.skills._shared.fft_defect import fft_defect_map, make_defective_lattice
from corvex.skills._shared.strain import make_strained_lattice
