...
from corvex.agents.exp_agents._locked_exec import atomic_np_save
...
def _chi2_gate():
    from corvex.agents.exp_agents.quality_gate import QualityGate
...
def test_log_context_attribution_and_prefix(tmp_path):
    ...
    from corvex.utils.log_context import (
