...
from corvex.skills.structure_matching.xrd.fingerprint import (  # noqa: E402
    build_fingerprint_library, search_match_pattern, TOOL_SPEC as FP_SPEC)
from corvex.skills.structure_matching.xrd.calibrate_zero import (  # noqa: E402
...
def test_materialize_dangling_path_falls_back_gracefully(tiny_library, tmp_path,
    ...
    import pandas as pd
    from corvex.skills.structure_matching.xrd import fingerprint as fp
    ...
    monkeypatch.setenv("CORVEX_COD_ALLOW_WEB", "0")          # simulate offline
    tt = [28.442, 47.303, 56.121, 69.130, 76.377, 88.032]
    ii = [100.0, 55.0, 30.0, 6.0, 11.0, 12.0]
