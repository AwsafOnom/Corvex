...
import corvex.agents.exp_agents.controllers.curve_fitting_controllers as cc
import corvex.agents.exp_agents.analysis_orchestrator_tools as tools_mod
...
class TestIdModeLiteratureGates:
    ...
    def test_agent_docstring_no_longer_claims_stage2_consumption(self):
        import corvex.agents.exp_agents.curve_fitting_agent as agent_mod
...
class TestRefineInterpretationPlumbing:
    ...
    def test_effective_full_result_helper(self):
        from corvex.agents.exp_agents.analysis_orchestrator_tools import _effective_full_result
...
class TestOrchestratorSurface:
    def test_followups_suggest_refinement(self):
        import corvex.agents.exp_agents.analysis_orchestrator as orch_mod
