...
from corvex.agents.sim_agents.simulation_pipeline import _load_components_manifest
...
def test_orthogonalize_zero_tilt_drops_line(tmp_path):
    ...
    from corvex.agents.sim_agents._engine_inputs import _orthogonalize_zero_tilt
