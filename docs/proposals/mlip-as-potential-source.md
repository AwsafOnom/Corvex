...
Follow-up to [#429](https://github.com/ziatdinovmax/Corvex/issues/429), where the
...
A 26-query routing sweep (`Corvex-Benchmarks/benchmark/test_router.py`,
...
- **What decides FF-vs-MLIP?** **An LLM judgment guided by the skill**, in
  keeping with the rest of Corvex (skills inject knowledge, agents reason with
