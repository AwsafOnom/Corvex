...
```
corvex/skills/optimization/<name>/<name>.md
```
...
```
corvex/skills/optimization/<name>/
...
```python
from corvex.skills._shared._opt_components import SurrogateComponent
from corvex.agents.planning_agents.bo_tools import SurrogateSpec, SurrogateCapabilities
...
```python
from corvex.skills._shared._opt_components import AcquisitionComponent
...
- For a surrogate, smoke-test the structural contract while authoring:
  ...
  ```python
  from corvex.skills._shared._opt_components import get_surrogate_components, smoke_test_surrogate
